...
createOtherDivForSelect(htmlDropdown.parentElement) //az egyébnek letrehozunk es azert hivjuk meg ezt mert elote letre kell hozni
...
function hideBasedOnSelected(dropdownList){
    const ertek = dropdownList.value //elkerjuk az erteket ferfi / no
    const cardelem = dropdownList.parentElement.querySelectorAll(".card") // card osztalyal rendelkezo elemek
    for (const elem of cardelem) {
        elem.classList.add("hide")  //hozza adjuk a hide osztalyt      
    }
